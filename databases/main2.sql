...
CREATE TABLE IF NOT EXISTS `f1telemetria`.`sesionParticipaPiloto` (
  ...
  `nivelTecnico` INT NULL DEFAULT NULL COMMENT 'Se guarda en \"sesionParticipaPilotoConduciendoEquipo\" pero se actualiza el valor en \"piloto\". ¿Solo si aumenta, que es lo normal?',
